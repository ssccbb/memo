 ...
 *
 */
public class RoundImageViewWithCircle extends ImageView{
    ...
    public RoundImageViewWithCircle(Context context) {
        super(context);
        mContext = context;
    }

    public RoundImageViewWithCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public RoundImageViewWithCircle(Context context, AttributeSet attrs, int defStyle) {
