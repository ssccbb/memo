...
/**
 * Created by sung on 16/3/21.
 */
public class SlideCutMenuListView extends ListView{
    /**禁止侧滑模式*/
    ...
    public SlideCutMenuListView(Context context) {
        this(context, null);
    }

    public SlideCutMenuListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideCutMenuListView(Context context, AttributeSet attrs, int defStyle) {
